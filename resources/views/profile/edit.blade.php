...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Profil Düzenle') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" autocomplete="address">{{ old('address', $user->address) }}</textarea>
