            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title">Müşteri Toplu Yükleme</h3>
                        <a href="{{ route('customers.index') }}" class="btn btn-secondary btn-sm">
                            <i class="fas fa-arrow-left"></i> Müşteriler Listesine Dön
                        </a>
                    </div>
                </div>
                <div class="card-body">
...
Jane Smith,jane@example.com,pass456,2,5559876543,Ankara Turkey</pre>
                    ...
                    <form method="POST" action="{{ route('customers.import.process') }}" enctype="multipart/form-data">
                        @csrf
