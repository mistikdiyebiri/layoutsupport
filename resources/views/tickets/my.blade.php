        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <form action="{{ route('tickets.my') }}" method="GET" class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <select name="department" class="form-select" onchange="this.form.submit()">
                                    <option value="all" {{ request('department') == 'all' ? 'selected' : '' }}>Tüm Departmanlar</option>
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('tickets.my') }}" class="btn btn-secondary w-100">Sıfırla</a>
                            </div>
                        </form>
                    </div>
